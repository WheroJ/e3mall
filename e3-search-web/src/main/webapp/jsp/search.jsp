    ...
    <div class="p-list">
      <ul class="list-all">
         ...
         <li>
            <div class="l-wrap">
				<div class="pic">
					<%-- http://localhost:8086/item/${item.id}.html
						http://localhost/pages/${item.id}.html
					 --%>
	            ...
	            <div class="title-a">
	                <a class="trackref presaleSign_225865" href="http://localhost/pages/${item.id}.html" target="_blank">${item.title }</a>
	            </div>
	        	<div class="title-b" style=""><a class="trackref" href="http://localhost/pages/${item.id}.html" target="_blank">${sell_point }</a></div>
	            <div class="comment">
